# Function: bwe:fill_block_unified__else_6
...
execute if score @s _slice_h matches ..0 run function bwe:fill_block_unified__if_9
execute if score @s _slice_h > @s bwe_dim_y run function bwe:fill_block_unified__if_10
...
execute if score @s _temp matches ..0 run function bwe:fill_block_unified__if_11
...
execute if score @s _tile_x matches ..0 run function bwe:fill_block_unified__if_12
execute if score @s _tile_x > @s bwe_dim_x run function bwe:fill_block_unified__if_13
...
execute if score @s _tile_z matches ..0 run function bwe:fill_block_unified__if_14
execute if score @s _tile_z > @s bwe_dim_z run function bwe:fill_block_unified__if_15
