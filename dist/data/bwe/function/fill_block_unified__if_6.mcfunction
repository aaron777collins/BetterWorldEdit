# Function: bwe:fill_block_unified__if_6
...
execute if score @s _temp >= @s bwe_dim_z run function bwe:fill_block_unified__if_7
execute unless score @s _temp >= @s bwe_dim_z run function bwe:fill_block_unified__else_6
