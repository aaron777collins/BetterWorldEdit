# Function: bwe:process_fill_tick__else_12
...
execute if score @s _ue > @s bwe_max_x run function bwe:process_fill_tick__if_36
...
execute if score @s _ve > @s bwe_max_z run function bwe:process_fill_tick__if_37
