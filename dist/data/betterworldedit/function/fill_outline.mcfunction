...
execute if score @s bwe_volume matches 0 run function betterworldedit:fill_outline__if_1
execute unless score @s bwe_volume matches 0 run function betterworldedit:fill_outline__else_1