# Function: betterworldedit:fill_block__else_2
...
execute if score @s _slice_h matches ..0 run function betterworldedit:fill_block__if_3
execute if score @s _slice_h > @s bwe_dim_y run function betterworldedit:fill_block__if_4
...
execute if score @s _area_limit matches ..0 run function betterworldedit:fill_block__if_5
...
execute if score @s _tile_x matches ..0 run function betterworldedit:fill_block__if_6
execute if score @s _tile_x > @s bwe_dim_x run function betterworldedit:fill_block__if_7
...
execute if score @s _tile_z matches ..0 run function betterworldedit:fill_block__if_8
execute if score @s _tile_z > @s bwe_dim_z run function betterworldedit:fill_block__if_9
