...
execute if score @s bwe_volume matches 0 run function betterworldedit:fill_block__if_1
execute unless score @s bwe_volume matches 0 run function betterworldedit:fill_block__else_1