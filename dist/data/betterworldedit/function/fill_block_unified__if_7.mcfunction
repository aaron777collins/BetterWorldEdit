# Function: betterworldedit:fill_block_unified__if_7
execute if score @s _fill_desc matches 0 run function betterworldedit:fill_block_unified__if_8
execute unless score @s _fill_desc matches 0 run function betterworldedit:fill_block_unified__else_5
