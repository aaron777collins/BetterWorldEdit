...
scoreboard players operation @s temp_6 = @s bwe_dim_x
scoreboard players operation @s temp_6 *= @s bwe_dim_z
scoreboard players operation @s _base = @s temp_6
scoreboard players operation @s temp_7 = @s bwe_max_fill
scoreboard players operation @s temp_7 /= @s _base
scoreboard players operation @s _slice_h = @s temp_7
...
scoreboard players add @s temp_8 0
